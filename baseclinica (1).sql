...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-11-2023 a las 14:25:57
...
(1001, 'Calle Marfin 1301 - Distrito Los Olivos'),
(1002, 'Av. Diagonal 550 - oficina 302A- Distrito Miraflores');
...
(71420304, 'JULIO', 'GRANDA', 902482504, 'juliogs1999@gmail.com'),
(74906725, 'RICHARD', 'GALINDO', 900184767, 'rgalindomiranda@gmail.com');
...
(4, 74906725, '2023-12-09', '1:00 PM', 1002, 'dwadwadwa'),
(5, 71420304, '2023-12-09', '2:00 M', 1002, 'dwadwada');
...
ALTER TABLE `reserva`
  ...
  ADD KEY `Fk_ReservaClinica` (`IdClinica`),
