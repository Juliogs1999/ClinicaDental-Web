<?php
    ...
    $rs = mysqli_query($cn,"UPDATE paciente SET nompaciente='$nompaciente', apepaciente='$apepaciente', telfpaciente='$telfpaciente', correopaciente='$correopaciente' WHERE idpaciente=$idpaciente"); 
    mysqli_close($cn);
